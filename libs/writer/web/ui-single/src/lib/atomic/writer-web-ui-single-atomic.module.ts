...
@NgModule({
  ...
  exports: [CommonModule, EditprofileFormMolec, InfoFormMolec, ChangepwFormMolec, FormProfieOrgan, ImageProfileOrgan, ChangePhotoMolec, ProfileTemplate],
  declarations: [EditprofileFormMolec, InfoFormMolec, ChangepwFormMolec, FormProfieOrgan, ImageProfileOrgan, ChangePhotoMolec, ProfileTemplate],
})
